      ...
      steps {
        withCredentials([
          ...
          sh '''
            ...
            TRIVY_USERNAME=$TRIVY_USERNAME TRIVY_PASSOWRD=$TRIVY_PASSWORD trivy fs --scanners misconfig,vuln,secret --sast TRIVY_DB_REPOSITORY="registry.aquasec.com/trivy-db:2 TRIVY_CHECKS_BUNDLE_REPOSITORY="registry.aquasec.com/trivy-checks:1 .
          '''
        }
      }
    }
